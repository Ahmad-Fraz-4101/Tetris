...
public:
	...
	void drop(int r, int** ar)
	{
		...
		{
			if (i < 19 && (ar[i][j] == 0) && (ar[i][j + 1] == 0) && (ar[i + 1][j + 2] == 0))
			{
				setlocationy(getlocationy() + 22);
			}
			else
	...
	void mover(int r, int** ar)
	{
		...
		{
			if(i>0)
			if (getlocationx() <= 264 && (ar[i][j + 2] == 0) && (ar[i - 1][j + 2] == 0) && (ar[i + 1][j + 2] == 0))
			{
				setlocationx(getlocationx() + 22);
			}
		}
		...
		{
			if(i>0)
			if (getlocationx() <= 262 && (ar[i][j + 1] == 0) && (ar[i - 1][j + 2] == 0) && (ar[i +1][j + 1] == 0))
			{
				setlocationx(getlocationx() + 22);
			}
		}
		...
		{
			if(i>0)
			if (getlocationx() <= 242 && (ar[i][j + 3] == 0) && (ar[i - 1][j + 1] == 0))
			{
				setlocationx(getlocationx() + 22);
			}
		}
		...
		{
			if(i>0)
			if (getlocationx() <= 262 && (ar[i ][j + 3] == 0)&& (ar[i -1][j + 3] == 0))
			{
				setlocationx(getlocationx() + 22);
			}
		}
	...
	void draw(sf::RenderWindow& window, int** ar)
	{
		...
		for (int r = 0; r < 4; r++)
		{
			for (int c = 0; c < 4; c++)
			{
				...
				sf::Color color = (arr[r][c] == 6) ? sf::Color::Color(0, 0, 128) : sf::Color::Transparent;
